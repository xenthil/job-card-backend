...
router.put('/job-types/:id', JobTypeController_1.updateJobType); // Route to update a JoType
router.delete('/job-types/:id', JobTypeController_1.removeJobType); // Route to remove a JoType
